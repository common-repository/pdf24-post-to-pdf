...
Donate link: https://www.pdf24.org/
...
* Some minor changes regarding SEO improvements

= 4.2.1 =
* Checked compatibility with Wordpress 4.9.6

= 4.2.0 =
* Optimized styles of the article sub plugin and and top bottom bar plugin
* Added some more image icons
* Changed some icons in the templates
* Checked compatibility with Wordpress 4.7.3
...
* Fixed option page styles
* PDF creation progress popup contains like, share, +1 buttons which are connected with your blog pages and by which you can get likes, shares and +1 for your blog pages.

= 4.0.0 =
* Minor changes and compatibility check with Wordpress 4.4.2
